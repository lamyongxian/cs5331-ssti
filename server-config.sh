...
#mkdir -p -m a=rwx /home/vagrant/cs5331-ssti >/dev/null 2>&1
#git clone https://github.com/lamyongxian/cs5331-ssti.git /home/vagrant/cs5331-ssti >/dev/null 2>&1
pwd

# Run Maven
#echo "[+]" $( date +%T ) "Run Maven Package"
#cd /vagrant/freemarker/CS5331SSTI/ && sudo mvn clean package -DskipTests >/dev/null 2>&1
